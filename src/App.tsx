...
function App() {
  ...
  return(
    ...
    <section id='navbar' className={isDarkMode ? "dark-mode" : "light-mode"}><NavBar/></section>
    <div className={`theme-button ${isDarkMode ? "hidden" : ""}`} onClick={toggleDarkMode}>
          <svg
      ...
      <div data-bs-spy="scroll" data-bs-target="#navbar" data-bs-root-margin="0px 0px -40%" data-bs-smooth-scroll="true" className="scrollspy-example bg-body-tertiary rounded-2" tabIndex={0}>
        ...
        <section id='home' className={isDarkMode ? "dark-mode" : "light-mode"}>
          <Home/>
        </section>
